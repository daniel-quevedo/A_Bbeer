document.addEventListener("DOMContentLoaded", function() {
  dataTable = new DataTable(document.getElementById('table-mesa'), {
    language: {
...
function importExcel() {
  ...
  .then((data) => {
    if (data.message == 'success') {
      ...
      data.info == 'true' ? titleInfo = 'Nombre de mesa duplicado en el excel' : titleInfo;
      Toast.fire({
        icon: 'error',
        title: titleInfo
      })
